...
data = {"userId":20275521,"tokenId":"USDT","currencyId":"RUB","payment":["75"],"side":"1","size":"50","page":"1","amount":"","authMaker":False,"canTrade":False,"itemRegion":2}
...
for i in items:
    ...
    if sum_rub > need_rub:
        break
    sum_rub += float(i['lastQuantity']) * float(i['price'])
    sum_usdt += float(i['lastQuantity'])


print(f"sum_rub: {sum_rub}")
print(f"sum_usdt: {sum_usdt}")
print(f"price: {sum_rub/sum_usdt}")
